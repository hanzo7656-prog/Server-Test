...
module.exports = {
  ...
  ALL_TRADING_PAIRS: [
    ...
    "comp_usdt", "mkr_usdt", "zeo_usdt", "dash_usdt", "waves_usdt", "omg_usdt", "zil_usdt",
    ...
    "kmd_usdt", "pixx_usdt", "grs_usdt", "nav_usdt", "emo2_usdt", "sys_usdt", "via_usdt",
    "mona_usdt", "dcr_usdt", "sia_usdt", "lbc_usdt", "rep_usdt", "gnt_usdt", "loom_usdt",
    "poly_usdt", "ren_usdt", "fun_usdt", "reg_usdt", "salt_usdt", "mtl_usdt", "mco_usdt",
    "edo_usdt", "powr_usdt", "eng_usdt", "ast_usdt", "dgd_usdt", "adx_usdt", "qsp_usdt",
    "mda_usdt", "snt_usdt", "agix_usdt", "ocean_usdt", "band_usdt", "nmr_usdt", "ric_usdt",
    ...
    "kno_usdt", "bal_usdt", "uma_usdt", "badger_usdt", "fxs_usdt", "cvx_usdt", "tribe_usdt",
    "gno_usdt", "ilus_usdt", "pla_usdt", "super_usdt", "ach_usdt", "imx_usdt", "gods_usdt",
    "vra_usdt", "sps_usdt", "dar_usdt", "mgn_usdt", "ceek_usdt", "vr_usdt", "bmx_usdt",
    ...
    "chz_usdt", "ankr_usdt", "ski_usdt", "arpa_usdt", "strax_usdt", "mbl_usdt", "quick_usdt",
