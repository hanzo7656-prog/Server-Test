        ...
        const bodyContent = `
            ...
            <script>
                ...
                function loadSampleData() {
                    const sampleCoins = [
                        {symbol: 'BTC', price: 45234.56, priceChange24h: 2.34, change_1h: 0.56, volume: 25467890000, marketCap: 885234567890, VortexAI_analysis: {signal_strength: 8.7, market_sentiment: 'bullish', volatility_score: 7.2, volume_anomaly: true}},
                        {symbol: 'ETH', price: 2345.67, priceChange24h: 1.23, change_1h: -0.34, volume: 14567890000, marketCap: 281234567890, VortexAI_analysis: {signal_strength: 7.2, market_sentiment: 'bullish', volatility_score: 5.8, volume_anomaly: false}},
                        {symbol: 'SOL', price: 102.34, priceChange24h: 5.67, change_1h: 2.12, volume: 3456789000, marketCap: 41234567890, VortexAI_analysis: {signal_strength: 9.1, market_sentiment: 'very bullish', volatility_score: 8.5, volume_anomaly: true}}
                    ];
    ...
    router.get('/api-data', (req, res) => {
        ...
        const bodyContent = `
            ...
            <script>
                ...
                // برای دریافت داده‌های واقعی از API
                ...
                function displayCoins(coins) {
                    ...
                    const coinsHTML = coins.map(coin => {
                        // استفاده از فیلدهای واقعی - پشتیبانی از نام‌های مختلف فیلدها
                ...
                function getCoinIcon(symbol) {
                    const iconMap = { 
                        'BTC': 'B', 'ETH': 'E', 'SOL': 'S', 'ADA': 'A', 'DOT': 'D', 
                        'BNB': 'B', 'XRP': 'X', 'DOGE': 'D', 'LTC': 'L', 'LINK': 'L', 
                        'AVAX': 'A', 'MATIC': 'M', 'ATOM': 'A', 'UNI': 'U', 'AAVE': 'A'
                    };
